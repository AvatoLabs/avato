...
### 安全配置示例（摘自环境变量）
- 认证与 OIDC
  - AUTH_SECRET、JWKS_KEY、ENABLE_OIDC、AUTH_* 各提供商 ID/Secret。
- 数据库与密钥
...
**章节来源**
- [packages/database/src/models/__tests__/apiKey.test.ts](file://packages/database/src/models/__tests__/apiKey.test.ts#L174-L183)
