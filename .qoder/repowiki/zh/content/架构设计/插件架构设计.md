...
- 内置工具包：packages/builtin-tool-*/src/* 提供各工具的清单、执行运行时与类型定义
...
- [apps/desktop/src/main/controllers/__tests__/McpInstallCtr.test.ts](file://apps/desktop/src/main/controllers/__tests__/McpInstallCtr.test.ts#L60-L106)
- [packages/types/src/plugins/protocol.ts](file://packages/types/src/plugins/protocol.ts#L45-L101)
- [apps/desktop/src/main/types/protocol.ts](file://apps/desktop/src/main/types/protocol.ts#L29-L60)
