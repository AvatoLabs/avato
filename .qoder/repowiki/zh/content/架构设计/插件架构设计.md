...
class SourceSetExecutionRuntime {
-ragService RagService
+searchSourceSet(args, options) BuiltinServerRuntimeOutput
+readSourceFiles(args, options) BuiltinServerRuntimeOutput
}
...
SourceSetExecutionRuntime --> "依赖" RagService
