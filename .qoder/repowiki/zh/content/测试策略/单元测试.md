...
- Zustand Mock：通过 **mocks**/zustand/traditional.ts 提供传统模式下的 store 行为模拟，便于隔离 UI 与状态逻辑
...
- [**mocks**/zustand/traditional.ts（Zustand Mock 示例）](file://__mocks__/zustand/traditional.ts)
- [tests/mocks/lru_map.ts（LRU Map Mock 示例）](file://tests/mocks/lru_map.ts)
