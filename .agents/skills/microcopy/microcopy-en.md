...
It is a unified workspace where you can find, build, or team up with agent co-workers.Simply describe what you need, and Avato will generate the prompts and assemble the right set of tools to compose your agent.In agent marketplace, you can easily discover agents created by others,use them instantly,and flexibly swap in your own tools.
