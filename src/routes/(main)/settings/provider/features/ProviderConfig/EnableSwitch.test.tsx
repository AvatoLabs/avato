...
vi.mock('@/store/aiInfra', () => ({
  ...
  aiProviderSelectors: {
    isAiProviderConfigLoading: () => () => providerState.isLoading,
    isProviderEnabled: () => () => providerState.enabled,
  },
}));

describe('ProviderConfig EnableSwitch', () => {
  beforeEach(() => {
    vi.clearAllMocks();
