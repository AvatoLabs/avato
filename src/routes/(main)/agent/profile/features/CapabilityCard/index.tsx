...
import AgentKnowledgeInline from '../ProfileEditor/AgentKnowledgeInline';
...
const CapabilityCard = memo(() => {
    ...
    const [config] = useAgentStore(
        (s) => [agentSelectors.currentAgentConfig(s)],
        isEqual,
    );
            ...
            },
            {
                ...
                label: (
                    <Flexbox horizontal align={'center'} gap={12}>
                        ...
                        <Flexbox flex={1}>
                            <span style={{ fontSize: 14, fontWeight: 500 }}>
                                {t('settingAgent.knowledge.title')}
                            </span>
                            <span
                                style={{
                                    fontSize: 12,
