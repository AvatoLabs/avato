export default {
  ...
  'builtins.lobe-source-set.apiName.readSourceFiles': 'Read collection content',
  'builtins.lobe-source-set.apiName.searchSourceSet': 'Search collections',
  'builtins.lobe-source-set.inspector.andMoreFiles': 'and {{count}} more',
  'builtins.lobe-source-set.inspector.noResults': 'No results',
  'builtins.lobe-source-set.title': 'Collection',
