export default {
  ...
  'protocolInstall.official.badge': 'MinkHub Official Skill',
  'protocolInstall.official.description': 'Official MinkHub Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. MinkHub does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.title': 'Add skills to Mink AI',
