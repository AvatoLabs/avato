export default {
  ...
  'builtins.lobe-source-set.apiName.readSourceFiles': 'Read reference-set content',
  'builtins.lobe-source-set.apiName.searchSourceSet': 'Search reference sets',
  'builtins.lobe-source-set.inspector.andMoreFiles': 'and {{count}} more',
  'builtins.lobe-source-set.inspector.noResults': 'No results',
  'builtins.lobe-source-set.title': 'Reference Set',
  ...
  'builtins.lobe-docs-agent.apiName.batchUpdate': 'Batch update nodes',
  'builtins.lobe-docs-agent.apiName.compareSnapshots': 'Compare snapshots',
  'builtins.lobe-docs-agent.apiName.convertToList': 'Convert to list',
  'builtins.lobe-docs-agent.apiName.createNode': 'Create node',
  'builtins.lobe-docs-agent.apiName.cropImage': 'Crop image',
  'builtins.lobe-docs-agent.apiName.deleteNode': 'Delete node',
  'builtins.lobe-docs-agent.apiName.deleteSnapshot': 'Delete snapshot',
  'builtins.lobe-docs-agent.apiName.deleteTableColumn': 'Delete table column',
  'builtins.lobe-docs-agent.apiName.deleteTableRow': 'Delete table row',
  'builtins.lobe-docs-agent.apiName.duplicateNode': 'Duplicate node',
  'builtins.lobe-docs-agent.apiName.editTitle': 'Rename doc title',
  'builtins.lobe-docs-agent.apiName.editTitle.result': 'Rename title to "<title>{{title}}</title>"',
  'builtins.lobe-docs-agent.apiName.getDocContent': 'Get document structure',
  'builtins.lobe-docs-agent.apiName.indentListItem': 'Indent list item',
  'builtins.lobe-docs-agent.apiName.initDoc': 'Start writing content',
  'builtins.lobe-docs-agent.apiName.initDoc.chars': ' chars',
  'builtins.lobe-docs-agent.apiName.initDoc.creating': 'Creating document',
  'builtins.lobe-docs-agent.apiName.initDoc.lines': ' lines',
  'builtins.lobe-docs-agent.apiName.initDoc.result': 'Document created',
  'builtins.lobe-docs-agent.apiName.insertTableColumn': 'Insert table column',
  'builtins.lobe-docs-agent.apiName.insertTableRow': 'Insert table row',
  'builtins.lobe-docs-agent.apiName.listSnapshots': 'List snapshots',
  'builtins.lobe-docs-agent.apiName.mergeNodes': 'Merge nodes',
  'builtins.lobe-docs-agent.apiName.modifyNodes': 'Modify doc',
  'builtins.lobe-docs-agent.apiName.modifyNodes.addNodes': 'Add content',
  'builtins.lobe-docs-agent.apiName.modifyNodes.deleteNodes': 'Delete content',
  'builtins.lobe-docs-agent.apiName.modifyNodes.init': 'Preparing to modify',
  'builtins.lobe-docs-agent.apiName.modifyNodes.result': '+{{insert}} / ~{{modify}} / -{{remove}}',
  'builtins.lobe-docs-agent.apiName.moveNode': 'Move node',
  'builtins.lobe-docs-agent.apiName.outdentListItem': 'Outdent list item',
  'builtins.lobe-docs-agent.apiName.replaceText': 'Replace text',
  'builtins.lobe-docs-agent.apiName.replaceText.count': '{{count}} replaced',
  'builtins.lobe-docs-agent.apiName.replaceText.empty': '(empty)',
  'builtins.lobe-docs-agent.apiName.replaceText.init': 'Preparing to replace',
  'builtins.lobe-docs-agent.apiName.resizeImage': 'Resize image',
  'builtins.lobe-docs-agent.apiName.restoreSnapshot': 'Restore snapshot',
  'builtins.lobe-docs-agent.apiName.rotateImage': 'Rotate image',
  'builtins.lobe-docs-agent.apiName.saveSnapshot': 'Save snapshot',
  'builtins.lobe-docs-agent.apiName.setImageAlt': 'Set image alt text',
  'builtins.lobe-docs-agent.apiName.splitNode': 'Split node',
  'builtins.lobe-docs-agent.apiName.toggleListType': 'Toggle list type',
  'builtins.lobe-docs-agent.apiName.unwrapNode': 'Unwrap node',
  'builtins.lobe-docs-agent.apiName.updateNode': 'Update node',
  'builtins.lobe-docs-agent.apiName.wrapNodes': 'Wrap nodes',
  'builtins.lobe-docs-agent.title': 'Doc',
  ...
  'protocolInstall.official.badge': 'Avatofficial Skill',
  'protocolInstall.official.description': 'Official Avatokill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Avatooes not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.title': 'Add skills to Avato',
  ...
  'store.actions.installFailed': 'Failed to install Skill',
  'store.actions.install': 'Install',
  'store.actions.manifest': 'Edit manifest',
  'store.actions.settings': 'Settings',
  'store.actions.uninstallFailed': 'Failed to uninstall Skill',
