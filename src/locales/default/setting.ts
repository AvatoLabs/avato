export default {
  ...
  'agentCronJobs.createFailed': 'Failed to create scheduled task',
  ...
  'agentCronJobs.form.validation.agentRequired': 'Agent ID is required',
  'agentCronJobs.form.validation.completeRequired': 'Please fill in all required fields',
  ...
  'agentCronJobs.form.validation.nameAndContentRequired': 'Name and content are required',
  ...
  'settingSources.badge.collection': 'Collection',
  'settingSources.count': '{{count}} attached',
  'settingSources.desc':
    'Manage long-term sources for this agent. Files added from the attachment picker stay at conversation scope and are not mixed into agent sources.',
  'settingSources.empty': 'No long-term sources yet',
  'settingSources.emptyDesc':
    'Attach files or collections from Content for long-term reuse across conversations.',
  'settingSources.inlineAdd': 'Add Sources',
  'settingSources.item.fileDesc': 'Long-term file source',
  'settingSources.item.collectionDesc': 'Long-term collection',
  'settingSources.profileButton': 'Sources',
  'settingSources.profileButtonCount': 'Sources ({{count}})',
  ...
  'settingSources.section.collections': 'Collections',
  ...
  'settingSources.emptyDescInWorkspace':
    'Attach files or collections from {{name}} for long-term reuse across conversations.',
  'checking': 'Checking...',
  ...
  'group.system': 'System',
  'mcpStudio.badge': 'Beta',
  'mcpStudio.binding.add': 'Add binding',
  'mcpStudio.binding.count': '{{count}} bindings',
  'mcpStudio.binding.desc': 'Map flow variables into JSON paths before the MCP tool runs.',
  'mcpStudio.binding.empty':
    'No payload bindings yet. Add one to wire the prompt into the tool payload.',
  'mcpStudio.binding.notice':
    'Bindings write values into the payload after JSON parsing, so the base JSON can stay simple.',
  'mcpStudio.binding.target': 'Target JSON path, for example query or filters.repo',
  'mcpStudio.binding.title': 'Payload bindings',
  'mcpStudio.canvas.desc':
    'A light in-product graph that turns one MCP call into a chat-ready flow.',
  'mcpStudio.canvas.drag': 'Drag',
  'mcpStudio.canvas.hint':
    'Double-click the canvas to add a battery. Drag from an output port into a target input port to wire the graph. Press Space to open the command palette.',
  'mcpStudio.canvas.panZoom': 'Scroll to zoom. Middle-drag to pan the canvas.',
  'mcpStudio.canvas.status.connected': 'Connected',
  'mcpStudio.canvas.status.done': 'Preview ready',
  'mcpStudio.canvas.status.idle': 'Waiting for a connection',
  'mcpStudio.canvas.status.running': 'Running',
  'mcpStudio.canvas.title': 'Flow Canvas',
  'mcpStudio.agent.empty': 'Pick an agent to enable this battery, then shape its prompt below.',
  'mcpStudio.agent.memory': 'Memory persona',
  'mcpStudio.agent.memoryDesc':
    'Inject the latest saved persona into this battery when memory is enabled for the selected agent.',
  'mcpStudio.agent.model': 'Model',
  'mcpStudio.agent.params': 'Model params JSON',
  'mcpStudio.agent.prompt': 'Agent prompt template',
  'mcpStudio.agent.select': 'Select an agent',
  'mcpStudio.agent.systemRole': 'System role',
  'mcpStudio.agent.title': 'Agent Node',
  'mcpStudio.chat.assistant': 'Assistant',
  'mcpStudio.chat.system': 'System',
  'mcpStudio.chat.user': 'User',
  'mcpStudio.breakpoint.desc':
    'Pause Studio preview after this battery finishes. Resume and step execution are not supported yet.',
  'mcpStudio.breakpoint.label': 'Breakpoint',
  'mcpStudio.connections.attach': 'Attach wire',
  'mcpStudio.connections.connected': 'Connected',
  'mcpStudio.connections.incoming': 'Incoming',
  'mcpStudio.connections.none': 'No wires yet.',
  'mcpStudio.connections.outgoing': 'Outgoing',
  'mcpStudio.connections.pending': 'Wiring',
  'mcpStudio.connections.title': 'Connections',
  'mcpStudio.connection.args':
    'Args JSON, for example ["-y", "@modelcontextprotocol/server-github"]',
  'mcpStudio.connection.authBearer': 'Bearer token',
  'mcpStudio.connection.authNone': 'No auth',
  'mcpStudio.connection.authOAuth': 'OAuth token',
  'mcpStudio.connection.command': 'Local command, for example npx or uvx',
  'mcpStudio.connection.connect': 'Connect',
  'mcpStudio.connection.desc':
    'Point the studio at one MCP server, load its tools, and keep the config local to this demo.',
  'mcpStudio.connection.desktopOnly':
    'STDIO mode needs the desktop app because the server process runs on your machine.',
  'mcpStudio.connection.env': 'Env JSON, for example {"GITHUB_TOKEN":"..."}',
  'mcpStudio.connection.headers': 'Headers JSON, for example {"X-Workspace":"design"}',
  'mcpStudio.connection.http': 'HTTP',
  'mcpStudio.connection.identifier': 'Server name',
  'mcpStudio.connection.installed': 'installed',
  'mcpStudio.connection.refresh': 'Reload tools',
  'mcpStudio.connection.stdio': 'STDIO',
  'mcpStudio.connection.title': 'Connection',
  'mcpStudio.connection.token': 'Access token',
  'mcpStudio.connection.url': 'Streamable HTTP URL',
  'mcpStudio.hero.desc':
    'Use the existing MCP stack as the runtime, keep the GUI light, and preview how a workflow DSL can feed chat.',
  'mcpStudio.hero.kicker': 'MCP -> DSL -> Chat',
  'mcpStudio.hero.points.compose': 'Map one tool call into a compact workflow DSL',
  'mcpStudio.hero.points.connect': 'Connect to an MCP server with the current runtime chain',
  'mcpStudio.hero.points.preview':
    'Preview the final chat-facing output without leaving the workspace',
  'mcpStudio.hero.title': 'Studio',
  'mcpStudio.input.binding':
    'Use {{humanPrompt}} in the JSON payload or transform prompt to bind the user message into the flow.',
  'mcpStudio.input.desc':
    'Capture the user message here and feed it into the MCP call or the chat shaping step.',
  'mcpStudio.input.empty': 'No human prompt yet. Add one in the input panel.',
  'mcpStudio.input.payloadBadge': 'Payload',
  'mcpStudio.input.prompt': 'Human prompt, for example Show open issues for lobehub this week',
  'mcpStudio.input.title': 'Input Node',
  'mcpStudio.library.count': 'saved flows',
  'mcpStudio.library.defaultName': 'Untitled workflow',
  'mcpStudio.library.delete': 'Delete',
  'mcpStudio.library.desc':
    'Save named local snapshots so you can switch Studio flows without rebuilding them.',
  'mcpStudio.library.draft': 'Draft',
  'mcpStudio.library.edited': 'Unsaved changes',
  'mcpStudio.library.empty': 'No saved workflows yet. Save the current flow to reuse it later.',
  'mcpStudio.library.load': 'Load',
  'mcpStudio.library.loaded': 'Workflow loaded',
  'mcpStudio.library.name': 'Workflow name',
  'mcpStudio.collection.new': 'New draft',
  'mcpStudio.library.removed': 'Workflow deleted',
  'mcpStudio.library.save': 'Save workflow',
  'mcpStudio.library.saved': 'Workflow saved',
  'mcpStudio.library.savedShort': 'Saved',
  'mcpStudio.library.saving': 'Saving...',
  'mcpStudio.library.select': 'Select a saved workflow',
  'mcpStudio.collection.title': 'Workflow Library',
  'mcpStudio.library.update': 'Update workflow',
  'mcpStudio.library.updated': 'Workflow updated',
  'mcpStudio.header.addNode': 'Add node',
  'mcpStudio.header.export': 'Export',
  'mcpStudio.header.more': 'More',
  'mcpStudio.header.searchCommands': 'Search commands',
  'mcpStudio.commandPalette.empty': 'No matching commands found.',
  'mcpStudio.commandPalette.searchAll': 'Search nodes and commands',
  'mcpStudio.commandPalette.searchNodes': 'Search node types',
  'mcpStudio.commandPalette.title': 'Command Palette',
  'mcpStudio.messages.connectFailed': 'Connection failed',
  'mcpStudio.messages.librarySyncFailed': 'Could not sync this workflow with the server',
  'mcpStudio.messages.connectSuccess': 'Connected and loaded {{count}} tools',
  'mcpStudio.messages.draftCleared': 'Local draft cleared',
  'mcpStudio.messages.draftCopied': 'Draft copied',
  'mcpStudio.messages.draftCopyFailed': 'Could not copy the draft',
  'mcpStudio.messages.exportFailed': 'Could not export this workflow',
  'mcpStudio.messages.exported': 'Workflow exported',
  'mcpStudio.messages.invalidConnection': 'These two batteries cannot be wired together.',
  'mcpStudio.messages.invalidArray': 'Use a JSON string array here.',
  'mcpStudio.messages.invalidPort': 'Those two ports do not accept the same value type.',
  'mcpStudio.messages.invalidRecord': 'Use a JSON object here.',
  'mcpStudio.messages.layoutReset': 'Canvas layout reset',
  'mcpStudio.messages.missingHttp': 'Fill in both the server name and HTTP URL first.',
  'mcpStudio.messages.missingStdio': 'Fill in both the server name and local command first.',
  'mcpStudio.messages.newDraft': 'New workflow draft ready',
  'mcpStudio.messages.nodeDeleted': 'Battery removed',
  'mcpStudio.messages.pendingConnection': 'Pick a target battery to finish wiring.',
  'mcpStudio.messages.portBusy': 'This input port has reached its connection limit.',
  'mcpStudio.messages.resourceBinary': 'This resource is binary. Import a text resource instead.',
  'mcpStudio.messages.resourceImportFailed': 'Could not import this resource',
  'mcpStudio.messages.resourceImported': 'Resource imported',
  'mcpStudio.messages.resourceListFailed': 'Could not load the resource list for this skill',
  'mcpStudio.messages.selectionDeleted': 'Deleted {{count}} selected items',
  'mcpStudio.messages.breakpointPaused': 'Flow paused at breakpoint: {{nodeTitle}}',
  'mcpStudio.messages.runFailed': 'Flow run failed',
  'mcpStudio.messages.runSuccess': 'Flow run complete',
  'mcpStudio.messages.serverLoaded': 'Loaded MCP server with {{count}} tools',
  'mcpStudio.messages.skillEmpty': 'This skill does not expose text content yet.',
  'mcpStudio.messages.skillImportFailed': 'Could not import this skill',
  'mcpStudio.messages.skillImported': 'Skill imported',
  'mcpStudio.meta.lastRun': 'Last run',
  'mcpStudio.meta.pending': 'Pending',
  'mcpStudio.meta.ready': 'Generated from current state',
  'mcpStudio.meta.selectedTool': 'Selected tool',
  'mcpStudio.meta.server': 'Server',
  'mcpStudio.meta.title': 'Runtime Snapshot',
  'mcpStudio.meta.tools': 'tools',
  'mcpStudio.node.agent': 'Agent',
  'mcpStudio.node.agentDesc':
    'Run a selected agent inside the flow so one graph can hand work across multiple agents.',
  'mcpStudio.node.chat': 'Chat',
  'mcpStudio.node.chatDesc':
    'Render a chat-ready preview from the tool result and transform instruction.',
  'mcpStudio.node.input': 'Input',
  'mcpStudio.node.inputDesc':
    'Capture the user prompt and payload before they enter the workflow runtime.',
  'mcpStudio.node.resource': 'Resource',
  'mcpStudio.node.resourceDesc':
    'Bring a file, image, or text note into the graph as shared context.',
  'mcpStudio.node.skill': 'Skill',
  'mcpStudio.node.skillDesc': 'Import a skill body and route it through downstream batteries.',
  'mcpStudio.node.tool': 'MCP Tool',
  'mcpStudio.node.title': 'Battery name',
  'mcpStudio.node.transform': 'Transform',
  'mcpStudio.node.transformDesc': 'Describe how the raw tool result should be shaped for chat.',
  'mcpStudio.panel.runtime': 'Runtime',
  'mcpStudio.panel.selected': 'Selected Battery',
  'mcpStudio.panel.wire': 'Selected Wire',
  'mcpStudio.port.config': 'Cfg',
  'mcpStudio.port.content': 'Content',
  'mcpStudio.port.context': 'Ctx',
  'mcpStudio.port.handoff': 'Hand',
  'mcpStudio.port.main': 'Main',
  'mcpStudio.port.message': 'Msg',
  'mcpStudio.port.primary': 'In',
  'mcpStudio.port.prompt': 'Prompt',
  'mcpStudio.port.resource': 'Res',
  'mcpStudio.port.result': 'Out',
  'mcpStudio.port.skill': 'Skill',
  'mcpStudio.preview.dsl': 'Workflow DSL',
  'mcpStudio.preview.empty': 'Run the flow once to see tool output here.',
  'mcpStudio.preview.fallback.assistant': 'Run the flow to preview a chat-ready answer.',
  'mcpStudio.preview.fallback.request': 'Run the selected workflow output.',
  'mcpStudio.preview.fallback.server': 'workflow',
  'mcpStudio.preview.fallback.system': 'Shape the workflow output for chat.',
  'mcpStudio.preview.fallback.tool': 'tool',
  'mcpStudio.preview.fallback.user':
    'Run {{tool}} through {{server}} and prepare the response for chat. Request: {{request}}',
  'mcpStudio.preview.result': 'Tool Output',
  'mcpStudio.preview.schema': 'Selected Tool Schema',
  'mcpStudio.run.desc': 'Execute the current graph and inspect the downstream preview.',
  'mcpStudio.run.execute': 'Run flow',
  'mcpStudio.run.idle': 'No result yet. Connect a server and run the flow to fill this node.',
  'mcpStudio.run.title': 'Chat Preview',
  'mcpStudio.run.unavailable':
    'Connect at least one runnable source battery to the selected output before running the graph.',
  'mcpStudio.runtime.breakpoint': 'Execution paused',
  'mcpStudio.runtime.breakpointDesc':
    'The graph stopped after "{{nodeTitle}}" because a breakpoint is enabled on that battery.',
  'mcpStudio.runtime.noOutput': 'Select a chat battery as the output.',
  'mcpStudio.runtime.output': 'Output',
  'mcpStudio.runtime.setOutput': 'Set as output',
  'mcpStudio.selection.clear': 'Clear selection',
  'mcpStudio.selection.count': '{{nodes}} nodes · {{edges}} wires',
  'mcpStudio.selection.delete': 'Delete selected',
  'mcpStudio.selection.desc':
    'Drag on the canvas to marquee-select multiple batteries and wires. Hold Shift, Ctrl, or Cmd to add to the current selection.',
  'mcpStudio.selection.shortcut': 'Press Delete or Backspace to remove the current selection.',
  'mcpStudio.selection.title': 'Selection',
  'mcpStudio.summary.agent': 'Select an agent and shape the prompt.',
  'mcpStudio.summary.chat': 'Select this output and run the graph to preview chat.',
  'mcpStudio.summary.input': 'Double-click to edit the prompt.',
  'mcpStudio.summary.resource': 'Bring a file, image, or text note into the graph as context.',
  'mcpStudio.summary.resourceImported': 'Imported',
  'mcpStudio.summary.skill': 'Import a skill body as upstream context.',
  'mcpStudio.summary.skillImported': 'Imported',
  'mcpStudio.summary.tool': 'Pick an MCP server and a tool.',
  'mcpStudio.summary.transform': 'Summarize the upstream result for chat.',
  'mcpStudio.section.input': 'Input & Bindings',
  'mcpStudio.section.setup': 'Setup',
  'mcpStudio.section.transform': 'Transform',
  'mcpStudio.toolbar.addBattery': 'Add Battery',
  'mcpStudio.toolbar.agents': 'agents',
  'mcpStudio.toolbar.autoLayout': 'Auto layout',
  'mcpStudio.toolbar.batteries': 'batteries',
  'mcpStudio.toolbar.fitView': 'Fit view',
  'mcpStudio.toolbar.loadMcp': 'Load MCP',
  'mcpStudio.toolbar.servers': 'servers',
  'mcpStudio.toolbar.wires': 'wires',
  'mcpStudio.tool.desc': 'Pick one MCP capability that receives the bound input payload.',
  'mcpStudio.tool.empty': 'Connect a server to inspect its tools.',
  'mcpStudio.tool.parameters': 'Tool arguments JSON',
  'mcpStudio.tool.title': 'Tool Node',
  'mcpStudio.resource.content': 'Resource notes or extracted text',
  'mcpStudio.resource.importDesc':
    'Import a resource from an installed skill, upload a local file, or add readable content and notes below.',
  'mcpStudio.resource.importSkill': 'Select a skill to import from',
  'mcpStudio.resource.importTitle': 'Import from a skill resource',
  'mcpStudio.resource.kind.file': 'File',
  'mcpStudio.resource.kind.image': 'Image',
  'mcpStudio.resource.kind.text': 'Text',
  'mcpStudio.resource.mimeType': 'MIME type',
  'mcpStudio.resource.path': 'Imported resource path',
  'mcpStudio.resource.skill': 'Import from skill',
  'mcpStudio.resource.sourceLabel': 'Resource name',
  'mcpStudio.resource.sourceType.manual': 'Manual',
  'mcpStudio.resource.sourceType.skill-resource': 'Skill import',
  'mcpStudio.resource.sourceType.upload': 'Upload',
  'mcpStudio.resource.sourceUri': 'Resource URL or path',
  'mcpStudio.resource.title': 'Resource Node',
  'mcpStudio.resource.upload': 'Upload file',
  'mcpStudio.skill.content': 'Imported skill content',
  'mcpStudio.skill.skill': 'Skill',
  'mcpStudio.skill.title': 'Skill Node',
  'mcpStudio.storage.clear': 'Clear draft',
  'mcpStudio.storage.copy': 'Copy draft',
  'mcpStudio.storage.notice':
    'This local draft keeps layout and payloads, but strips tokens and other secret values before saving.',
  'mcpStudio.storage.resetLayout': 'Reset layout',
  'mcpStudio.storage.restored': 'Draft restored',
  'mcpStudio.transform.default': 'Summarize the upstream result for chat.',
  'mcpStudio.transform.desc':
    'Use instruction mode to describe how chat should be shaped, or template mode to render the final preview directly.',
  'mcpStudio.transform.binding':
    'Available variables: {{humanPrompt}}, {{toolResult}}, {{toolName}}, {{serverIdentifier}}.',
  'mcpStudio.transform.mode.instruction': 'Instruction',
  'mcpStudio.transform.mode.template': 'Template',
  'mcpStudio.transform.prompt': 'Describe how to shape the tool result',
  'mcpStudio.transform.title': 'Transform Node',
  'mcpStudio.variables.humanPrompt': 'Human prompt',
  'mcpStudio.variables.payloadDesc':
    'Click to insert a variable at the cursor in the payload JSON.',
  'mcpStudio.variables.serverIdentifier': 'Server name',
  'mcpStudio.variables.title': 'Bindings',
  'mcpStudio.variables.toolName': 'Tool name',
  'mcpStudio.variables.toolResult': 'Tool result',
  'mcpStudio.variables.upstreamResult': 'Upstream result',
  'mcpStudio.variables.transformDesc':
    'Click to insert a variable at the cursor in the transform prompt.',
  'mcpStudio.wire.attachPrompt': 'Attach a source wire first, then edit its payload bindings here.',
  'mcpStudio.wire.bindingDesc': 'Map values carried by this wire into the destination MCP payload.',
  'mcpStudio.wire.agent': 'Agent route',
  'mcpStudio.wire.openInspector': 'Edit wire',
  'mcpStudio.wire.output': 'Chat route',
  'mcpStudio.wire.payload': 'Payload route',
  'mcpStudio.wire.readonlyDesc':
    'This wire only passes the upstream result forward. Edit the destination battery to change how it interprets that input.',
  'mcpStudio.wire.readonlyTitle': 'This wire has no editable payload mapping',
  'mcpStudio.wire.upstream': 'Upstream route',
  'groupTab.chat': 'Chat',
  ...
  'settingAppearance.neutralColor.desc': 'Fine-tune the neutral surfaces and grayscale balance',
  'settingAppearance.neutralColor.lockedDesc':
    'Select Custom Theme before editing the neutral color',
  ...
  'settingAppearance.themePreset.options.custom.title': 'Custom Theme',
  'settingAppearance.themePreset.options.ember.desc': 'Warm and vivid',
  'settingAppearance.themePreset.options.ember.title': 'Ember',
  'settingAppearance.themePreset.options.forest.desc': 'Deep green and vivid',
  'settingAppearance.themePreset.options.forest.title': 'Forest',
  'settingAppearance.themePreset.options.midnight.desc': 'Sharp and focused',
  'settingAppearance.themePreset.options.midnight.title': 'Midnight',
  'settingAppearance.themePreset.options.obsidian.desc': 'Monochrome black and white',
  'settingAppearance.themePreset.options.obsidian.title': 'Obsidian',
  'settingAppearance.themePreset.options.surge.desc': 'Vivid sky blue with punch',
  'settingAppearance.themePreset.options.surge.title': 'Surge',
  ...
  'settingChat.chatStyleType.type.docs': 'Docs Mode',
  ...
  'settingCommon.saveFailed': 'Failed to save settings',
  'settingCommon.themeMode.desc':
    'Choose light, dark, or follow system. Color schemes apply to both.',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'systemAgent.queryRewrite.title': 'Reference-set query rewrite Agent',
