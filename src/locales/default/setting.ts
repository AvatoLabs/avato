export default {
  ...
  'settingKnowledge.count': '{{count}} attached',
  'settingKnowledge.desc':
    'Manage long-term knowledge for this agent. Files added from the attachment picker stay at conversation scope and are not mixed into agent knowledge.',
  ...
  'settingKnowledge.profileButtonCount': 'Knowledge ({{count}})',
  ...
  'mcpStudio.library.new': 'New draft',
  ...
  'mcpStudio.library.title': 'Workflow Library',
