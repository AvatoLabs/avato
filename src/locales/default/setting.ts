export default {
  ...
  'mcpStudio.canvas.hint':
    'Double-click the canvas to add a battery. Drag from an output port into a target input port to wire the graph.',
  'mcpStudio.canvas.panZoom': 'Scroll to zoom. Hold Space or middle-drag to pan the canvas.',
