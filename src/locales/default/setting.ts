export default {
  ...
  'llm.aesGcm':
    'Your keys and proxy address will be encrypted using the <1>AES-GCM</1> encryption algorithm',
  ...
  'llm.customModelCards.modelConfig.vision.extra':
    'This only enables image upload in the app. Whether the model supports vision depends on the model itself—please test it.',
  ...
  'settingChatAppearance.transitionMode.options.none.desc':
    "This depends on the model's response output method; please test it yourself.",
  ...
  'settingModel.reasoningEffort.desc':
  ...
  'settingModel.temperature.warning':
    'If the creativity level is set too high, the output may become garbled.',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'sync.warning.tip':
    'After a long period of community testing, WebRTC synchronization may not reliably meet general data synchronization needs. Please <1>deploy a signaling server</1> before use.',
  'sync.webrtc.channelName.desc':
    'WebRTC will use this name to create a sync channel. Ensure the channel name is unique.',
  ...
  'sync.webrtc.channelPassword.desc':
    'Add a password to ensure channel privacy. Only devices with the correct password can join the channel.',
  ...
  'sync.webrtc.desc':
    'Real-time, peer-to-peer data communication requires all devices to be online for synchronization.',
  'sync.webrtc.enabled.invalid':
    'Please fill in the signaling server and synchronization channel name before enabling.',
