export default {
  ...
  'mcpStudio.node.resourceDesc':
    'Import a text resource and feed it into the graph as upstream context.',
  ...
  'mcpStudio.resource.content': 'Imported resource content',
  'mcpStudio.resource.path': 'Resource path',
  'mcpStudio.resource.skill': 'Source skill',
  ...
  'mcpStudio.transform.default':
    'Summarize the tool result for chat. Keep the answer short, concrete, and easy to act on.',
