export default {
  ...
  'favorites.empty': 'Star items from the context menu to see them here.',
  'favorites.kind.document': 'Document',
  'favorites.kind.file': 'File',
  'favorites.subtitle': 'Quick access to your starred resources.',
