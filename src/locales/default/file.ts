export default {
  ...
  'emptyState.files.createPageAction': 'Create Page',
  'emptyState.files.description': 'Upload files or create pages to get started',
  ...
  'pageList.filter.onlyUnassigned': 'Unassigned Only',
  ...
  'pageList.scope.inbox': 'Needs Sorting',
  'pageList.scope.inboxHint': 'Right-click a doc or use the row menu to assign it to a source set.',
