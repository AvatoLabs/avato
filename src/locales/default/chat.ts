export default {
  ...
  'conversationFiles.picker.action.createSourceSet': 'New Reference Set',
  'conversationFiles.picker.action.openResources': 'Open Content',
  'conversationFiles.picker.action.upload': 'Upload Files',
  'conversationFiles.picker.allFiles': 'Standalone Files',
  'conversationFiles.picker.allFilesDesc': 'Files outside any reference set.',
  'conversationFiles.picker.attachedCount': '{{count}} file(s) already in this conversation',
  'conversationFiles.picker.desc':
    'Browse reference sets and folders, then add the files you need to this conversation.',
  'conversationFiles.picker.empty': 'No files here yet.',
  'conversationFiles.picker.emptySearch': 'No files match "{{query}}"',
  'conversationFiles.picker.folderHint': 'Open this folder to browse files inside it.',
  'conversationFiles.picker.scope': 'Current conversation',
  'conversationFiles.picker.searchPlaceholder': 'Search files and folders',
  'conversationFiles.picker.sources': 'Content',
  'conversationFiles.picker.subfolder': 'Subfolder',
  'conversationFiles.picker.title': 'Add Files',
  'conversationFiles.relatedFiles': 'In This Conversation',
  'conversationFiles.viewMore': 'Add from Content',
  ...
  'sourceSet.all': 'All Content',
  'sourceSet.allFiles': 'All Files',
  'sourceSet.allSourceSets': 'All Reference Sets',
  'sourceSet.disabled':
    'Reference-set chat isn’t available in this deployment. Switch to a server-side database, or use {{cloud}}.',
  'sourceSet.picker.action.add': 'Add',
  'sourceSet.picker.action.addSourceSet': 'Add Reference Set',
  'sourceSet.picker.action.addVisible': 'Add This View',
  'sourceSet.picker.action.added': 'Added',
  'sourceSet.picker.action.browse': 'Browse',
  'sourceSet.picker.action.createSourceSet': 'New Reference Set',
  'sourceSet.picker.action.openResources': 'Open Content',
  ...
  'sourceSet.picker.allFilesDesc': 'Files outside any reference set.',
  'sourceSet.picker.attachedCount': '{{sourceSets}} reference sets and {{files}} files added',
  'sourceSet.picker.desc':
    'Attach a whole reference set, or drill into folders to add only the files you need.',
  'sourceSet.picker.empty': 'No files here yet.',
  'sourceSet.picker.folderHint': 'Open this folder to browse files inside it.',
  'sourceSet.picker.scope': 'Agent sources',
  'sourceSet.picker.searchPlaceholder': 'Search files in this location',
  'sourceSet.picker.sources': 'Content',
  'sourceSet.picker.sourceWorkspace': 'From {{name}}',
  'sourceSet.picker.subfolder': 'Subfolder',
  'sourceSet.picker.title': 'Add Sources',
  'sourceSet.picker.workspace': 'Workspace',
  'sourceSet.picker.workspaceHint': 'Browsing content from {{name}} first.',
  'sourceSet.relatedSources': 'Related Files / Reference Sets',
  'sourceSet.title': 'Reference Sets',
  'sourceSet.uploadGuide': "Uploaded files appear in the 'Content' section.",
  'sourceSet.viewMore': 'View More',
  ...
  'owner': 'Group owner',
  'docsCopilot.title': 'Docs Agent',
  'docsCopilot.welcome': `**Clearer, sharper writing**\n\nDraft, rewrite, or polish—tell me your intent and I'll refine the rest.`,
  'docsCopilot.table.cards.audit.prompt':
    'Scan for duplicates, inconsistent values, and obvious gaps, then tell me what to fix first.',
  'docsCopilot.table.cards.audit.title': 'Find issues first',
  'docsCopilot.table.cards.fillMissing.prompt':
    'Fill the cells that can be inferred safely. Keep the current structure and flag anything uncertain.',
  'docsCopilot.table.cards.fillMissing.title': 'Fill obvious blanks',
  'docsCopilot.table.cards.normalize.prompt':
    'Standardize column names, dates, and status values without changing the meaning.',
  'docsCopilot.table.cards.normalize.title': 'Standardize values',
  'docsCopilot.table.cards.reshape.prompt':
    'Review this table structure, split overloaded columns, merge duplicate fields, and suggest a cleaner schema.',
  'docsCopilot.table.cards.reshape.title': 'Reshape the schema',
  'docsCopilot.table.cards.summary.prompt':
    'Summarize this table for me: row count, missing data, inconsistent values, and the next cleanup actions.',
  'docsCopilot.table.cards.summary.title': 'Summarize the table',
  'docsCopilot.table.title': 'Table Assistant',
  'docsCopilot.table.welcome':
    '**Keep the table usable**\n\nFill blanks, standardize values, spot anomalies, or reshape columns without leaving this doc.',
  'docSelection.lines': 'Lines {{start}}-{{end}}',
  'docSelection.reference': 'Selected Text',
  'pin': 'Pin',
  'pinOff': 'Unpin',
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of AvatoAvAvatonot responsible for any consequences arising from this shared content.',
