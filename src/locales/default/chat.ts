export default {
  ...
  'conversationFiles.picker.action.createCollection': 'New Collection',
  ...
  'conversationFiles.picker.allFilesDesc': 'Files outside any collection.',
  'conversationFiles.picker.attachedCount': '{{count}} file(s) already in this conversation',
  'conversationFiles.picker.desc':
    'Browse collections and folders, then add the files you need to this conversation.',
  ...
  'collection.all': 'All Content',
  'collection.allFiles': 'All Files',
  ...
  'collection.picker.attachedCount': '{{collections}} collections and {{files}} files added',
  'collection.picker.desc':
    'Attach a whole collection, or drill into folders to add only the files you need.',
  ...
  'collection.picker.sourceWorkspace': 'From {{name}}',
  'collection.picker.subfolder': 'Subfolder',
  'collection.picker.title': 'Add Sources',
  'collection.picker.workspace': 'Workspace',
  'collection.picker.workspaceHint': 'Browsing content from {{name}} first.',
  'collection.relatedSources': 'Related Files / Collections',
  'collection.title': 'Collections',
  'collection.uploadGuide': "Uploaded files appear in the 'Content' section.",
