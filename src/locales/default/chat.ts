export default {
  ...
  'conversationFiles.library.action.addVisible': 'Add Visible Files',
  'conversationFiles.library.action.openResources': 'Open Resources',
  'conversationFiles.library.allFiles': 'Standalone Files',
  'conversationFiles.library.allFilesDesc': 'Files outside of any library.',
  'conversationFiles.library.attachedCount': '{{count}} file(s) already in this conversation',
  'conversationFiles.library.desc':
    'Browse libraries and sub-libraries, then add files to this conversation.',
  'conversationFiles.library.empty':
    'No attachable library files yet. Upload or parse documents in Resources first.',
  'conversationFiles.library.emptySearch': 'No files match "{{query}}"',
  'conversationFiles.library.folderHint': 'Open this folder to browse files inside it.',
  ...
  'conversationFiles.library.subLibrary': 'Sub-library',
  'conversationFiles.library.title': 'Import Knowledge',
  'conversationFiles.relatedFiles': 'In This Conversation',
  'conversationFiles.viewMore': 'Add from Library',
  ...
  'knowledgeBase.library.action.addVisible': 'Add Visible Files',
  'knowledgeBase.library.action.openResources': 'Open Resources',
  ...
  'knowledgeBase.library.attachedCount': '{{libraries}} libraries and {{files}} files added',
  'knowledgeBase.library.desc':
    'Attach a whole library, or drill into sub-libraries to add only the files you need.',
  'knowledgeBase.library.empty': 'No files in this location yet.',
  'knowledgeBase.library.folderHint': 'Open this folder to browse files inside it.',
  ...
  'knowledgeBase.library.subLibrary': 'Sub-library',
  'knowledgeBase.library.title': 'Import Knowledge',
  'knowledgeBase.relativeFilesOrLibraries': 'Related Files/Libraries',
  'knowledgeBase.title': 'Library',
  'knowledgeBase.uploadGuide': "Uploaded files can be viewed in the 'Library' section.",
