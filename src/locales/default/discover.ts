export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and contact support for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and contact support.',
  ...
  'createGuide.func1.title': 'Submit in Avato',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Avatoommunity.',
  'footer.title': 'Share your creation on Avatoommunity today',
  ...
  'groupAgents.status.unpublished.subtitle':
    'This Group is under review. To confirm its status, copy the link and contact support.',
  ...
  'models.providerInfo.apiTooltip': 'Avatoupports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Avatofficial Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on Avato',
  ...
  'skills.details.sidebar.platform.layout.avatohub': 'Skills are managed by Avatoutomatically',
  ...
  'skills.details.sidebar.platform.steps.avatohub':
    'Install directly from the Avatoarketplace with one click.',
