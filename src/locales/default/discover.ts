export default {
  ...
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>support@minkhub.com</email>.',
  ...
  'createGuide.func1.title': 'Submit in MinkHub',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the MinkHub Community.',
  'footer.title': 'Share your creation on MinkHub Community today',
  ...
  'models.providerInfo.apiTooltip': 'MinkHub supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'MinkHub Official Service',
  ...
  'skills.details.sidebar.platform.layout.minkhub': 'Skills are managed by MinkHub automatically',
  ...
  'skills.details.sidebar.platform.steps.minkhub':
    'Install directly from the MinkHub marketplace with one click.',
