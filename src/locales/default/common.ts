export default {
  ...
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use Avatoloud.',
  ...
  'cmdk.search.page': 'Document',
  'cmdk.search.pages': 'Documents',
