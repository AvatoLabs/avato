export default {
  ...
  'FileManager.actions.addToCollection': 'Add to Collection',
  ...
  'FileManager.actions.batchChunkingError': 'Failed to start batch chunking.',
  ...
  'FileManager.actions.confirmRemoveFromCollection':
    "You're about to remove {{count}} selected file(s) from this collection. They'll still be available in Content. Confirm to continue.",
  ...
  'FileManager.actions.deleteError': 'Failed to delete the selected files.',
  ...
  'FileManager.actions.moveToOtherCollection': 'Move to another Collection',
  'FileManager.actions.moveToRoot': 'Move to root directory',
  'FileManager.actions.moving': 'Moving...',
  'FileManager.loadFoldersError': 'Failed to load folders',
  'FileManager.actions.showFolderTree': 'Folder tree',
  'FileManager.actions.removeFromCollection': 'Remove from Collection',
  'FileManager.actions.removeFromCollectionError': 'Failed to remove file from Collection.',
  'FileManager.actions.removeFromCollectionSuccess': 'File removed successfully.',
  ...
  'FileManager.actions.setAssetRightsOwnerDescription':
    'This updates the rights owner for {{count}} selected assets.',
  'FileManager.actions.setAssetRightsOwnerHint': 'Leave this blank to clear the current owner.',
  'FileManager.actions.setAssetRightsOwnerTitle': 'Set rights owner for {{count}} assets',
  ...
  'FileManager.actions.updateReviewStatusSuccess': 'Review status updated for {{count}} assets.',
  'FileManager.actions.updateRightsOwnerSuccess': 'Rights owner updated for {{count}} assets.',
  ...
  'FileManager.config.showFilesInCollection': 'Show content in Collection',
  'FileManager.emptyStatus.actions.file': 'Upload File',
  'FileManager.emptyStatus.actions.folder': 'Upload Folder',
  'FileManager.emptyStatus.actions.collection': 'Create Collection',
  ...
  'collection.empty.description': 'Create a collection to organize reusable AI sources.',
  'collection.empty.search': 'No matching collection found',
