export default {
  ...
  'FileManager.actions.moveToOtherSourceSet': 'Move to another Reference Set',
  ...
  'FileManager.actions.removeFromSourceSet': 'Remove from Reference Set',
  'FileManager.actions.removeFromSourceSetError': 'Failed to remove file from Reference Set.',
  'FileManager.actions.removeFromSourceSetSuccess': 'File removed successfully.',
  ...
  'FileManager.emptyStatus.actions.sourceSet': 'Create Reference Set',
  ...
  'sourceSet.empty.description': 'Create a reference set to organize reusable AI sources.',
  'sourceSet.empty.search': 'No matching reference set found',
  'sourceSet.empty.title': 'No reference sets yet',
};
