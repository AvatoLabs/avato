export default {
  ...
  'emptyFileList': 'No files yet.',
  'files': 'Files',
  'messageDetail': 'Message Details',
  'notebook.confirmDelete': 'Delete this document?',
  'notebook.deletedRestoreHint':
    'Deleted from this topic. You can reopen it from its space or restore it from trash if needed.',
  'notebook.delete': 'Delete Doc',
  'notebook.empty': 'No docs yet. Docs linked to this topic will show up here.',
  'notebook.title': 'Topic Docs',
  'openInDocEditor': 'Open in Docs',
  'title': 'Workspace',
};
