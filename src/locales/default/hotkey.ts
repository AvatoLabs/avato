export default {
  ...
  'navigateToChat.desc': 'Switch to the Chat tab and enter Avato',
  ...
  'saveDocument.desc': 'Save all changes to the current doc immediately',
  'saveDocument.title': 'Save Doc',
