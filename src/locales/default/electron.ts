export default {
  ...
  'navigation.noPages': 'No docs yet',
  'navigation.onboarding': 'Onboarding',
  'navigation.page': 'Document',
  'navigation.pages': 'Documents',
  'navigation.pin': 'Pin',
  'navigation.pinned': 'Pinned',
  'navigation.provider': 'Provider',
  'navigation.recentView': 'Recent docs',
  'navigation.resources': 'Content',
  ...
  'remoteServer.configDesc': 'Connect to the remote Avatoerver to enable data synchronization',
  ...
  'sync.avatohubCloud.description': 'Officially provided cloud version',
  'sync.avatohubCloud.serverUrl.placeholder': 'Optional server address, default Avato Cloud',
  'sync.avatohubCloud.title': 'Avato Cloud',
