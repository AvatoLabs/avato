export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote MinkHub server to enable data synchronization',
  ...
  'sync.minkhubCloud.description': 'Officially provided cloud version',
  'sync.minkhubCloud.title': 'MinkHub Cloud',
