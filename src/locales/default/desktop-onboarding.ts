export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using MinkHub Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve MinkHub. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve MinkHub',
  ...
  'screen5.actions.signInCloud': 'Sign in to MinkHub Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your MinkHub Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'MinkHub Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own MinkHub server instance',
