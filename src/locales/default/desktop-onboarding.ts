export default {
  ...
  'screen5.actions.signInCloud': 'Sign in to Avatoloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Avatoloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Avatoloud',
  'screen5.methods.selfhost.description': 'Connect to your own Avatoerver instance',
