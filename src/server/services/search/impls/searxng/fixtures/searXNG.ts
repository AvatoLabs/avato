...
export const hetongxue: SearXNGSearchResponse = {
  ...
  results: [
    ...
    },
    {
      ...
      engine: 'duckduckgo',
      engines: ['duckduckgo'],
      parsed_url: ['https', 'v.qq.com', '/x/docs/a3228iquze8.html', '', '', ''],
      positions: [15],
      score: 0.066_666_666_666_666_67,
      template: 'default.html',
      title: '【何同学】和苹果CEO库克的采访_腾讯视频',
      url: 'https://v.qq.com/x/docs/a3228iquze8.html',
    },
    {
      category: 'general',
      content:
    ...
    },
    {
      ...
      engine: 'duckduckgo',
      engines: ['duckduckgo'],
      parsed_url: ['https', 'rlzy.gdufe.edu.cn', '/2024/0603/c7288a193155/docs.htm', '', '', ''],
      positions: [23],
      score: 0.043_478_260_869_565_216,
      template: 'default.html',
      title: '人力资源学院第二届火苗新媒体训练营 视频剪辑培训成功举办',
      url: 'https://rlzy.gdufe.edu.cn/2024/0603/c7288a193155/docs.htm',
    },
    {
      category: 'general',
      content:
