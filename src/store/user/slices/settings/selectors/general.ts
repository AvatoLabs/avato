...
const normalizeThemeColor = <T extends string>(value?: T | '') => (value ? value : undefined);

const neutralColor = (s: UserStore) => normalizeThemeColor(generalConfig(s).neutralColor);
const primaryColor = (s: UserStore) => normalizeThemeColor(generalConfig(s).primaryColor);
