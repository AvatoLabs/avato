/**
 * Avato Skill Server connection status
 */
...
/**
 * Avato Skill Tool definition (from Market API)
 */
...
/**
 * Avato Skill Provider definition (from Market API)
 */
...
/**
 * Avato Skill Server instance (user-connected provider)
 */
...
/**
 * Parameters for calling Avato Skill tool
 */
...
/**
 * Result of calling Avato Skill tool
 */
