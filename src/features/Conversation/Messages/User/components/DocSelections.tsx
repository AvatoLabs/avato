...
import { type DocSelection } from '@/types/index';
...
interface DocSelectionsProps {
  selections: DocSelection[];
}

const DocSelections = memo<DocSelectionsProps>(({ selections }) => {
