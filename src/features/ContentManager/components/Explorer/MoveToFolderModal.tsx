...
const MoveToFolderModal = memo<MoveToFolderModalProps>(({ open, onClose, fileId, sourceSetId }) => {
  ...
  const handleMove = async () => {
    try {
      // Use optimistic moveContentItem for instant UI update
      await moveContentItem(fileId, selectedFolderId);
  ...
  const handleMoveToRoot = async () => {
    try {
      // Use optimistic moveContentItem for instant UI update
      await moveContentItem(fileId, null);
