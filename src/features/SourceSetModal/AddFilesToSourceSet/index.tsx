...
const ModalContent = memo<ModalContentProps>(({ fileIds, sourceSetId }) => {
  ...
  return (
    <>
      ...
      <Flexbox padding={16} style={{ paddingTop: 0 }}>
        <SelectForm fileIds={fileIds} sourceSetId={sourceSetId} onClose={close} />
      </Flexbox>
    </>
  );
});
    ...
    createModal({
      ...
      children: (
        <Suspense fallback={<div style={{ minHeight: 200 }} />}>
          <ModalContent fileIds={params?.fileIds || []} sourceSetId={params?.sourceSetId} />
        </Suspense>
      ),
      footer: null,
      title: null,
