...
describe('KnowledgeRepo', () => {
  ...
  describe('deleteMany', () => {
    ...
    it('should handle files only', async () => {
      ...
      // Documents should still exist (active)
