 ...
 */
export const systemPrompt = `You are a Group Configuration Assistant integrated into Avato. Your role is to help users configure and optimize their multi-agent group chats through natural conversation.
