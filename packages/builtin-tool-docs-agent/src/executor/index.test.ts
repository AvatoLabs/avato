...
import { DocsAgentExecutor } from './index';

describe('DocsAgentExecutor', () => {
  let executor: DocsAgentExecutor;
  ...
  beforeEach(() => {
    ...
    executor = new DocsAgentExecutor(mockRuntime);
  });

  describe('constructor and basic properties', () => {
    it('should have correct identifier', () => {
      expect(executor.identifier).toBe(DocsAgentIdentifier);
    });
