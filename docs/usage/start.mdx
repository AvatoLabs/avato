...
<Steps>
  ...
  Follow the [Quickstart](/docs/usage/getting-started/lobe-ai) to start your first conversation with Mink AI. No setup needed.
...
<Cards>
  ...
  <Card href={'/docs/usage/getting-started/lobe-ai'} title={'Try Mink AI'} />
</Cards>
