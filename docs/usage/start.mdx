...
<Steps>
  ...
  Follow the [Quickstart](/docs/usage/getting-started/lobe-ai) to start your first conversation with Avato. No setup needed.
...
<Cards>
  ...
  <Card href={'/docs/usage/getting-started/lobe-ai'} title={'Try Avato'} />
</Cards>
