...
If you deploy behind Nginx, an ingress, or a CDN, keep the proxy read timeout slightly higher than the app route budget, and keep the app route budget higher than `MCP_TOOL_TIMEOUT`.
