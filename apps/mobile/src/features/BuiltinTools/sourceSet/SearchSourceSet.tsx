...
const SearchSourceSetRender = memo<MobileBuiltinRenderProps>(({ content, pluginState }) => {
  const colors = useThemeColors();
  const fileResults = useMemo(() => parseFileResults(content, pluginState), [content, pluginState]);
